    ...
    extends GoogleChart
{
    ...
    **/
    ...
    /**
    *** Sets the displayed date format
    **/
    ...
    /**
    *** Gets the displayed date format
    **/
    ...
    **/
    ...
    /**
    *** Gets the displayed time format
    **/
    ...
    **/
    ...
    /**
    *** Gets the calculated X-axis date tick count
    **/
    ...
    **/
    ...
    /**
    *** Gets the calculated Y-axis temperature tick count
    **/
    ...
    **/
    ...
    /**
    *** Adds a temperature data-set to the graph
    **/
    public void addDataSet(Color color, String legend, Temperature data[])
        throws Exception
    {
        ...
        for (int i = 0; i < data.length; i++) {
            GetScaledExtendedEncodedValue(yv,data[i].getTemperatureC(),this.minTempC,this.maxTempC);
    ...
    /**
    *** Adds random sample data to the temperature graph for debug purposes.<br>
    *** Debug purpores only<br>
    **/
        ...
        throws Exception
    {
        ...
        java.util.List<Temperature> dataSet[] = new java.util.List[setCount];
        for (int d = 0; d < dataSet.length; d++) {
            dataSet[d] = new Vector<Temperature>();
        }
        ...
        for (int t = 0; t < tempCount; t++) {
            ...
            for (int d = 0; d < dataSet.length; d++) {
                ...
                dataSet[d].add(new Temperature(ts,C[d]));
            }
        ...
        for (int d = 0; d < dataSet.length; d++) {
            ...
            this.addDataSet(color, "Temp " + (d+1), dataSet[d].toArray(new Temperature[dataSet[d].size()]));
        }
    ...
    /**
    *** Returns the URL for obtaining a fixed graph image
    **/
