    ...
    **/
    ...
    public static class TextIcon
    {
        ...
        public TextIcon(ImageIcon icon, int xOfs, int yOfs, int xSiz, int ySiz) {
            this(icon, xOfs, yOfs, xSiz, ySiz, 0, null);
        }
        public TextIcon(ImageIcon icon, int xOfs, int yOfs, int xSiz, int ySiz, int fontPt) {
            this(icon, xOfs, yOfs, xSiz, ySiz, fontPt, null);
        }
        public TextIcon(ImageIcon icon, int xOfs, int yOfs, int xSiz, int ySiz, int fontPt, String fontName) {
            this._init(icon, xOfs, yOfs, xSiz, ySiz, fontPt, fontName);
        }
        // ---
        ...
        public TextIcon(File file, int xOfs, int yOfs, int xSiz, int ySiz, int fontPt, String fontName) {
            this._init(LoadImageIcon(file), xOfs, yOfs, xSiz, ySiz, fontPt, fontName);
        }
        // ---
        public TextIcon(URL url, int xOfs, int yOfs, int xSiz, int ySiz) {
            this(url, xOfs, yOfs, xSiz, ySiz, 0, null);
        }
        public TextIcon(URL url, int xOfs, int yOfs, int xSiz, int ySiz, int fontPt) {
            this(url, xOfs, yOfs, xSiz, ySiz, fontPt, null);
        }
        public TextIcon(URL url, int xOfs, int yOfs, int xSiz, int ySiz, int fontPt, String fontName) {
            this._init(LoadImageIcon(url), xOfs, yOfs, xSiz, ySiz, fontPt, fontName);
        }
        // ---
