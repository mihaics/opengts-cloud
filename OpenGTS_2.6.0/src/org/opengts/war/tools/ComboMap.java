    ...
    extends OrderedMap<String,String>
{
    ...
    *** Constructor
    *** @param list   The list copied to this ComboMap (descriptions will be the same as the corresponding key)
    *** @param locale The locale used to Localize the strings in the list.
    **/
    public ComboMap(Collection<I18N.Text> list, Locale locale)
    {
        super();
        if (list != null) {
            for (I18N.Text ik : list) {
                String k = ik.toString(locale);
                this.put(k,k);
            }
        }
    }
    ...
    *** @param locale The locale used to Localize the strings in the list.
    **/
    public ComboMap(I18N.Text list[], Locale locale)
    {
        super();
        if (list != null) {
            for (I18N.Text ik : list) {
    ...
    **/
    public void insert(String key, String desc)
    {
        ...
        this.put(0, k, d); // insert as first
    }
    ...
    **/
    ...
    {
        return super.containsKeyIgnoreCase(key);
    }
