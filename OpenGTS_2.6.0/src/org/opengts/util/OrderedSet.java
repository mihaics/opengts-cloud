    ...
    implements Set<K>, java.util.List<K>, Cloneable
{
    ...
    **/
    ...
    /**
    *** Gets the ordered backing list for this OrderedSet.
    *** Warning: This method does not protect against having the set contain more than
    ...
    **/
    ...
    {
        //if (this.getBackingList().contains(obj)) {
        //  // has occured via mutiple thread access without synchronization
        //  Print.logStackTrace("Adding object twice to OrderedSet!!! " + obj);
        //}
