...
public class ColorTools
{
    ...
    public static ColorTools.RGB COLOR_DARK_YELLOW  = DARK_YELLOW;
    ...
    public static ColorTools.RGB COLOR_DARK_GRAY    = DARK_GRAY;
    public static ColorTools.RGB COLOR_LIGHT_GRAY   = LIGHT_GRAY;
    public static ColorTools.RGB COLOR_WHITE        = WHITE;
    public static ColorTools.RGB COLOR_CYAN         = CYAN;
    public static ColorTools.RGB COLOR_PINK         = PINK;
    public static ColorTools.RGB COLOR_MAGENTA      = MAGENTA;

    public static Color          black              = BLACK.toColor();
    public static Color          brown              = BROWN.toColor();
    public static Color          red                = RED.toColor();
    public static Color          orange             = ORANGE.toColor();
    public static Color          yellow             = YELLOW.toColor();
    public static Color          darkYellow         = DARK_YELLOW.toColor();
    public static Color          green              = GREEN.toColor();
    public static Color          blue               = BLUE.toColor();
    public static Color          purple             = PURPLE.toColor();
    public static Color          gray               = GRAY.toColor();
    public static Color          darkGray           = DARK_GRAY.toColor();
    public static Color          lightGray          = LIGHT_GRAY.toColor();
    public static Color          white              = WHITE.toColor();
    public static Color          cyan               = CYAN.toColor();
    public static Color          pink               = PINK.toColor();
    public static Color          magenta            = MAGENTA.toColor();
    ...
    **/
    ...
    {
        private int R   =  0; // 0..256
        private int G   =  0; // 0..256
        private int B   =  0; // 0..256
        private int A   = -1; // 0..256
        ...
        /* return a Color instance made from this RGB value */
        public Color toColor() {
            int r = this.R & 0xFF;
            int g = this.G & 0xFF;
            int b = this.B & 0xFF;
            return (this.A >= 0)? new Color(r,g,b,(this.A&0xFF)) : new Color(r,g,b);
        }
