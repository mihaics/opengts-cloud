...
$Opt_Tables      = "$GTS_STD_PKG.opt.tables";
...
%Class_names = (
    ...
    "EventData"         => $Standard_Tables . ".EventData",
    ...
    # --
    "DeviceMessage"     => $Extra_Tables    . ".DeviceMessage",
    "ReportJob"         => $Extra_Tables    . ".ReportJob",
