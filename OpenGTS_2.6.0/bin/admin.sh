...
case "$1" in 
    ...
    "EventData"         ) JMAIN="org.opengts.db.tables.EventData"            ;;
    ...
    # --
    "DeviceMessage"     ) JMAIN="org.opengts.extra.tables.DeviceMessage"     ;;
    "ReportJob"         ) JMAIN="org.opengts.extra.tables.ReportJob"         ;;
