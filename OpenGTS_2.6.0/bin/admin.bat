...
if "%1"=="EventData"         (set JTABLE=org.opengts.db.tables.EventData)            & goto foundTable
...
if "%1"=="DeviceMessage"     (set JTABLE=org.opengts.extra.tables.DeviceMessage)     & goto foundTable
if "%1"=="ReportJob"         (set JTABLE=org.opengts.extra.tables.ReportJob)         & goto foundTable
