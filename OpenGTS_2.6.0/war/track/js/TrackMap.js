...
function trackMapOnLoad()
{
    ...
    if (ControlCollapseOnLoad) {
        jsmControlDisplay(false);
    }
...
function trackMapSelectRegion()
{
    ...
    /* draw shape */
    if (jsmDrawShape(type,radM,jspt,color,true,"",-1)) {
        jsmSetFixedZoom(true);
        return;
    }
            ...
            req.onreadystatechange = function() {
                if (req.readyState == 4) {
                    ...
                    if ((lat != 0.0) || (lon != 0.0)) {
                        ...
                        jsmDrawShape("!");
                        jsmDrawShape("circle",200,[ new JSMapPoint(lat,lon) ],"#888855",true,"",-1);
                    }
