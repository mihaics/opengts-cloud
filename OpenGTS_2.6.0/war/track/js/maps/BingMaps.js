...
//     -Initial release (cloned from VirtualEarth.js)
// ----------------------------------------------------------------------------
...
function JSMap(element)
{
    ...
    /* map */
    try {
        this.bingMap = new Microsoft.Maps.Map(element, null);
        this.virtualEarthMap = this.bingMap;
    } catch (e) {
...
JSMap.prototype._addPushpin = function(pp) // JSMapPushpin
{
    ...
    ppMarker.SetTitle(" ");
    ppMarker.SetDescription(pp.getHTML());
    ppMarker.pp = pp;
